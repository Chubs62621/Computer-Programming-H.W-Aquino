...
int main ()
{
	...
	else if (month==2 && day >31 && year < 1900)
	cout << "Invalid Date" << endl;
	...
	else if (month==4 && day >31 && year < 1900)
	cout << "Invalid Date" << endl;
	if (month==5 && day	<=30 && year >=1900)
	cout <<"May" << " " << day <<","<< year<< endl;
	else if (month==5 && day >30 && year < 1900)
	cout << "Invalid Date" << endl;
	if (month==6 && day	<=31 && year >=1900)
	cout <<"June" << " " << day <<","<< year<< endl;
	else if (month==6 && day >31 && year < 1900)
	cout << "Invalid Date" << endl;
	if (month==7 && day <=30 && year >=1900)
	cout <<"July" << " " << day <<"," << year<< endl;
	else if (month==7 && day >30 && year < 1900)
	cout << "Invalid Date" << endl;
	...
	else if (month==11 && day >31 && year <1900)
	cout << "Invalid Date" << endl;
